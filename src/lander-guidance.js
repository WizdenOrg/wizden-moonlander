...
module.exports = { assess, verticalSentence, lateralSentence, constants: { BRAKE_DECELERATION, DECISION_LAG_S, MAX_DESCENT, GRAVITY, LATERAL_BRAKE, MAX_LATERAL, FINAL_DESCENT_ALTITUDE, FAR_FROM_PAD, FAR_DESCENT, LOW_ALTITUDE } };
